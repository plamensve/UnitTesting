...
class TestTruckDriver(TestCase):
    ...
    def test_earned_money_setter_if_money_is_bellow_0_raise_error_(self):
        td = TruckDriver('Ivan', 0.01)
        td.money_per_mile = 0.01
        td.add_cargo_offer("California", 2000)
    ...
    def test_eat_method(self):
        ...
        self.assertEqual(60, td.earned_money)
    ...
    def test_sleep_method(self):
        ...
        self.assertEqual(10, td.earned_money)

    def test_pump_gas(self):
        td = TruckDriver('Ivan', 10)
        td.earned_money = 1001
        td.pump_gas(1500)
        td.pump_gas(3000)

        self.assertEqual(1, td.earned_money)

    def test_repair_truck(self):
        td = TruckDriver('Ivan', 10)
        td.earned_money = 15001
        td.repair_truck(10000)
        td.repair_truck(20000)
        self.assertEqual(1, td.earned_money)
